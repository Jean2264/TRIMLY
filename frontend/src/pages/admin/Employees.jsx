...
function Employees() {
  ...
  const deleteEmployee = async () => {
    try {
      const response = await fetch(
        `http://localhost:3000/employees/${selectedEmployeeId}`,
        {
          method: "DELETE",
          headers: {
  ...
  return (
    <section className="employees">
      ...
      <DataTable columns={columns} data={employees} rowKey="idempleado" />
        ...
        <AuxModal title="Dar de baja empleado" onClose={closeDeleteModal}>
          {deleteResult === null ? (
            <div className="delete-confirmation">
              <p>¿Estás seguro de que querés dar de baja este empleado?</p>
